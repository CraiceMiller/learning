...
from .translator import MYTranslator #type: ignore
...
class FileManager():
    ...
    def read_file(self,fileName:str): 
        ...
        if fileName.endswith(".json"):
            return self.read_json(fileName,True)
    ...
    def storage_historial(self, fileName:str,reason:str="None")->None:
        h:str =r"C:\Users\Usuario Pc\Desktop\programming\data\Historial file.json"
        """Here I just storage all file i open so far into a json file"""
        if not self.file_exist(fileName): self.create_json(h)
    ...
    @overload
    def read_excel(self,fileName:str)->dict[str, pd.DataFrame]:
        ...

    @overload
    def read_excel(self,fileName:str,sheet_name:str)->pd.DataFrame:
        ...

    
    def read_excel(self,fileName:str,sheet_name:str|None=None):
