...
class BankOunt(ctk.CTk,Bank):
    ...
    @classmethod
    def initiation(cls, id_:int)->Self:
        """
        ...
        will return a empty BankOunt class. \n
            ...
            Ashley: 1236
        """
        info=sorted(cls.DATABASE,key=lambda id:id["id"])
        index=my_dict_binary(info,"id",id_)
        ...
        if index != -1: 
            ...
            try: 
                ...
                return cls(
                    balance=cls.DATABASE[index]["balance"], 
                    wallet=cls.DATABASE[index]["wallet"], 
                    name=cls.DATABASE[index]["username"],
                    debt=cls.DATABASE[index]["debt"],
                    id=cls.DATABASE[index]["id"],
                    user=cls.DATABASE[index]["user"],
                    password=cls.DATABASE[index]["password"]
                )
